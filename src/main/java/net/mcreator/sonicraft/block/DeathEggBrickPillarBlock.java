...
public class DeathEggBrickPillarBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:death_egg_brick_pillar")
	public static final Block block = null;
	public DeathEggBrickPillarBlock(SonicraftModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.NETHERITE).hardnessAndResistance(2.5f, 40f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("death_egg_brick_pillar");
		}
