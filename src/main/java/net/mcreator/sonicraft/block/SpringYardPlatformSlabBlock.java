...
public class SpringYardPlatformSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:spring_yard_platform_slab")
	public static final Block block = null;
	public SpringYardPlatformSlabBlock(SonicraftModElements instance) {
		super(instance, 250);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("spring_yard_platform_slab");
		}
