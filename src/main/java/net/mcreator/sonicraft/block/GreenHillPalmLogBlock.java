...
public class GreenHillPalmLogBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_hill_palm_log")
	public static final Block block = null;
	public GreenHillPalmLogBlock(SonicraftModElements instance) {
		super(instance, 174);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_hill_palm_log");
		}
