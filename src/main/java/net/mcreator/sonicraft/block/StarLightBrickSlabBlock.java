...
public class StarLightBrickSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_brick_slab")
	public static final Block block = null;
	public StarLightBrickSlabBlock(SonicraftModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("star_light_brick_slab");
		}
