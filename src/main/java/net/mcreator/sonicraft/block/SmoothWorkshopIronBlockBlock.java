...
public class SmoothWorkshopIronBlockBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:smooth_workshop_iron_block")
	public static final Block block = null;
	public SmoothWorkshopIronBlockBlock(SonicraftModElements instance) {
		super(instance, 233);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smooth_workshop_iron_block");
		}
