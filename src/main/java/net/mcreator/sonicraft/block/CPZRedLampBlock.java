...
public class CPZRedLampBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_red_lamp")
	public static final Block block = null;
	public CPZRedLampBlock(SonicraftModElements instance) {
		super(instance, 219);
	}
