...
import net.mcreator.sonicraft.procedures.GHZDirtUpdateTickProcedure;
...
public class EHZDirtPillarSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_dirt_pillar_slab")
	public static final Block block = null;
	public EHZDirtPillarSlabBlock(SonicraftModElements instance) {
		super(instance, 1026);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ehz_dirt_pillar_slab");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				GHZDirtUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
