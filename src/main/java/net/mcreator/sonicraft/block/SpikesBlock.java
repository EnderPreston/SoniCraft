...
import net.mcreator.sonicraft.procedures.SpikesEntityWalksOnTheBlockProcedure;
...
public class SpikesBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:spikes")
	public static final Block block = null;
	public SpikesBlock(SonicraftModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.CHAIN).hardnessAndResistance(1f, 15f).setLightLevel(s -> 0).harvestLevel(1)
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			...
			int z = pos.getZ();
			{
				...
				SpikesEntityWalksOnTheBlockProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
