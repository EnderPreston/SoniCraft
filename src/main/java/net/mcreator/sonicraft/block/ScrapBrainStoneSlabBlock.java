...
public class ScrapBrainStoneSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:scrap_brain_stone_slab")
	public static final Block block = null;
	public ScrapBrainStoneSlabBlock(SonicraftModElements instance) {
		super(instance, 290);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("scrap_brain_stone_slab");
		}
