...
public class CasinoNightStoneBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:casino_night_stone")
	public static final Block block = null;
	public CasinoNightStoneBlock(SonicraftModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("casino_night_stone");
		}
