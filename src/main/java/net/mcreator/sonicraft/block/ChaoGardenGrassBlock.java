...
public class ChaoGardenGrassBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chao_garden_grass")
	public static final Block block = null;
	public ChaoGardenGrassBlock(SonicraftModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chao_garden_grass");
		}
