...
public class StudiopolisPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_platform")
	public static final Block block = null;
	public StudiopolisPlatformBlock(SonicraftModElements instance) {
		super(instance, 343);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_platform");
		}
