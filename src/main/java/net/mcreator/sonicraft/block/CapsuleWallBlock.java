...
public class CapsuleWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:capsule_wall")
	public static final Block block = null;
	public CapsuleWallBlock(SonicraftModElements instance) {
		super(instance, 21);
	}
