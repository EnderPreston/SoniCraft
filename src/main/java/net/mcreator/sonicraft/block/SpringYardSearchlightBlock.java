...
public class SpringYardSearchlightBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:spring_yard_searchlight")
	public static final Block block = null;
	public SpringYardSearchlightBlock(SonicraftModElements instance) {
		super(instance, 251);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(0.5f, 10f).setLightLevel(s -> 4).harvestLevel(1)
			...
			setRegistryName("spring_yard_searchlight");
		}
