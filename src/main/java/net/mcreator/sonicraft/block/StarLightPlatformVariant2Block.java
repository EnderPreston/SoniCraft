...
public class StarLightPlatformVariant2Block extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_platform_variant_2")
	public static final Block block = null;
	public StarLightPlatformVariant2Block(SonicraftModElements instance) {
		super(instance, 264);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("star_light_platform_variant_2");
		}
