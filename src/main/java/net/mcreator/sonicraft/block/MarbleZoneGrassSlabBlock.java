...
public class MarbleZoneGrassSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:marble_zone_grass_slab")
	public static final Block block = null;
	public MarbleZoneGrassSlabBlock(SonicraftModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_zone_grass_slab");
		}
