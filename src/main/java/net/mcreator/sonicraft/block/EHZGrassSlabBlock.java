...
public class EHZGrassSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_grass_slab")
	public static final Block block = null;
	public EHZGrassSlabBlock(SonicraftModElements instance) {
		super(instance, 1016);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ehz_grass_slab");
		}
