...
public class SonicTheFightersArcadeCabinetBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:sonic_the_fighters_arcade_cabinet")
	public static final Block block = null;
	public SonicTheFightersArcadeCabinetBlock(SonicraftModElements instance) {
		super(instance, 52);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.ANVIL).hardnessAndResistance(1.5f, 25f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("sonic_the_fighters_arcade_cabinet");
		}
