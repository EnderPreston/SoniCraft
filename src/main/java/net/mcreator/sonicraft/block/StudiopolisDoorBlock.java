...
public class StudiopolisDoorBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_door")
	public static final Block block = null;
	public StudiopolisDoorBlock(SonicraftModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(0.6499999999999999f, 6f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("studiopolis_door");
		}
