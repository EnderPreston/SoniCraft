...
public class ScrapBrainIronSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:scrap_brain_iron_slab")
	public static final Block block = null;
	public ScrapBrainIronSlabBlock(SonicraftModElements instance) {
		super(instance, 286);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("scrap_brain_iron_slab");
		}
