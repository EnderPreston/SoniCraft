...
public class StudiopolisPopcornShopAwningBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_popcorn_shop_awning")
	public static final Block block = null;
	public StudiopolisPopcornShopAwningBlock(SonicraftModElements instance) {
		super(instance, 349);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_popcorn_shop_awning");
		}
