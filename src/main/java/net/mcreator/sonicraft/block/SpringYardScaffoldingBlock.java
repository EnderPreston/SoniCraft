...
public class SpringYardScaffoldingBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:spring_yard_scaffolding")
	public static final Block block = null;
	public SpringYardScaffoldingBlock(SonicraftModElements instance) {
		super(instance, 248);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spring_yard_scaffolding");
		}
