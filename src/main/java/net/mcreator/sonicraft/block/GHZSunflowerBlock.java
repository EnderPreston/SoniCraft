...
public class GHZSunflowerBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_sunflower")
	public static final Block block = null;
	public GHZSunflowerBlock(SonicraftModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ghz_sunflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ghz_sunflower"), configuredFeature);
		}
	}
	@SubscribeEvent
