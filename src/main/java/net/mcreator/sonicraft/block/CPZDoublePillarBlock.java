...
public class CPZDoublePillarBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_double_pillar")
	public static final Block block = null;
	public CPZDoublePillarBlock(SonicraftModElements instance) {
		super(instance, 221);
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("cpz_double_pillar");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("sonicraft:cpz_double_pillar_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 2)).range(120)
					.square().func_242731_b(28);
			event.getRegistry().register(feature.setRegistryName("cpz_double_pillar"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:cpz_double_pillar"), configuredFeature);
		}
	}
	@SubscribeEvent
