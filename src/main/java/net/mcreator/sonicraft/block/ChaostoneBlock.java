...
public class ChaostoneBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chaostone")
	public static final Block block = null;
	public ChaostoneBlock(SonicraftModElements instance) {
		super(instance, 188);
	}
