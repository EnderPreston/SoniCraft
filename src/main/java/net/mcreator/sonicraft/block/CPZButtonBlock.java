...
import net.mcreator.sonicraft.procedures.CPZButtonOnBlockRightClickedProcedure;
...
public class CPZButtonBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_button")
	public static final Block block = null;
	public CPZButtonBlock(SonicraftModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CPZButtonOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
