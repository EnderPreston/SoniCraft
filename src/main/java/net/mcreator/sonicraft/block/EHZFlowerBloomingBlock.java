...
public class EHZFlowerBloomingBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_flower_blooming")
	public static final Block block = null;
	public EHZFlowerBloomingBlock(SonicraftModElements instance) {
		super(instance, 1023);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ehz_flower_blooming"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ehz_flower_blooming"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ehz_flower_blooming");
		}
