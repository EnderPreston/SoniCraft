...
public class ScrapBrainStoneStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:scrap_brain_stone_stairs")
	public static final Block block = null;
	public ScrapBrainStoneStairsBlock(SonicraftModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("scrap_brain_stone_stairs");
		}
