...
public class EHZFlowerCurlingBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_flower_curling")
	public static final Block block = null;
	public EHZFlowerCurlingBlock(SonicraftModElements instance) {
		super(instance, 1021);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ehz_flower_curling"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ehz_flower_curling"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ehz_flower_curling");
		}
