...
public class StarLightRoadSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_road_slab")
	public static final Block block = null;
	public StarLightRoadSlabBlock(SonicraftModElements instance) {
		super(instance, 260);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("star_light_road_slab");
		}
