...
public class DeathEggOuterShellWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:death_egg_outer_shell_wall")
	public static final Block block = null;
	public DeathEggOuterShellWallBlock(SonicraftModElements instance) {
		super(instance, 318);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("death_egg_outer_shell_wall");
		}
