...
public class WorkshopRoofSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:workshop_roof_slab")
	public static final Block block = null;
	public WorkshopRoofSlabBlock(SonicraftModElements instance) {
		super(instance, 231);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("workshop_roof_slab");
		}
