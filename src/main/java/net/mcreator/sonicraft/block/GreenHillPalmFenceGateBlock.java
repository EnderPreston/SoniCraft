...
public class GreenHillPalmFenceGateBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_hill_palm_fence_gate")
	public static final Block block = null;
	public GreenHillPalmFenceGateBlock(SonicraftModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("green_hill_palm_fence_gate");
		}
