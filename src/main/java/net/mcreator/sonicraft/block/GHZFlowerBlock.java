...
public class GHZFlowerBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_flower")
	public static final Block block = null;
	public GHZFlowerBlock(SonicraftModElements instance) {
		super(instance, 13);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ghz_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ghz_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
