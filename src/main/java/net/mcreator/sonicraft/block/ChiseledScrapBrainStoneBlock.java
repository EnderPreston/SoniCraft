...
public class ChiseledScrapBrainStoneBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chiseled_scrap_brain_stone")
	public static final Block block = null;
	public ChiseledScrapBrainStoneBlock(SonicraftModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_scrap_brain_stone");
		}
