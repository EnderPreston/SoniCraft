...
public class AquaticRuinBricksBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:aquatic_ruin_bricks")
	public static final Block block = null;
	public AquaticRuinBricksBlock(SonicraftModElements instance) {
		super(instance, 273);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aquatic_ruin_bricks");
		}
