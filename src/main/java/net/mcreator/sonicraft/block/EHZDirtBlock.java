...
public class EHZDirtBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_dirt")
	public static final Block block = null;
	public EHZDirtBlock(SonicraftModElements instance) {
		super(instance, 1019);
	}
