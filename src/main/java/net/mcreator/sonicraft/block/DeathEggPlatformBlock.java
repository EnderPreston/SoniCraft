...
public class DeathEggPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:death_egg_platform")
	public static final Block block = null;
	public DeathEggPlatformBlock(SonicraftModElements instance) {
		super(instance, 330);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.LANTERN).hardnessAndResistance(1.5f, 25f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("death_egg_platform");
		}
