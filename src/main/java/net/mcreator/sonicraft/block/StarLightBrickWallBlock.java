...
public class StarLightBrickWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_brick_wall")
	public static final Block block = null;
	public StarLightBrickWallBlock(SonicraftModElements instance) {
		super(instance, 270);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("star_light_brick_wall");
		}
