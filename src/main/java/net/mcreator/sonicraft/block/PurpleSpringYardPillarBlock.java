...
public class PurpleSpringYardPillarBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:purple_spring_yard_pillar")
	public static final Block block = null;
	public PurpleSpringYardPillarBlock(SonicraftModElements instance) {
		super(instance, 254);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_spring_yard_pillar");
		}
