...
public class StudiopolisRoadStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_road_stairs")
	public static final Block block = null;
	public StudiopolisRoadStairsBlock(SonicraftModElements instance) {
		super(instance, 337);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_road_stairs");
		}
