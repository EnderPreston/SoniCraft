...
public class GHZDirtSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_dirt_slab")
	public static final Block block = null;
	public GHZDirtSlabBlock(SonicraftModElements instance) {
		super(instance, 172);
	}
