...
public class StarLightFrameWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_frame_wall")
	public static final Block block = null;
	public StarLightFrameWallBlock(SonicraftModElements instance) {
		super(instance, 266);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.LANTERN).hardnessAndResistance(1.25f, 15f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("star_light_frame_wall");
		}
