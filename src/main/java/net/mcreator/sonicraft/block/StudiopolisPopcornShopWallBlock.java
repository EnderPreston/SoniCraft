...
public class StudiopolisPopcornShopWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_popcorn_shop_wall")
	public static final Block block = null;
	public StudiopolisPopcornShopWallBlock(SonicraftModElements instance) {
		super(instance, 348);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_popcorn_shop_wall");
		}
