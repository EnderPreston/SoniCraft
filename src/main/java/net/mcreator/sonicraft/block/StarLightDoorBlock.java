...
public class StarLightDoorBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_door")
	public static final Block block = null;
	public StarLightDoorBlock(SonicraftModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.4000000000000001f, 9f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("star_light_door");
		}
