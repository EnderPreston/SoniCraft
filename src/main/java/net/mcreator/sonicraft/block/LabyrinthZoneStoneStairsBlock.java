...
public class LabyrinthZoneStoneStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:labyrinth_zone_stone_stairs")
	public static final Block block = null;
	public LabyrinthZoneStoneStairsBlock(SonicraftModElements instance) {
		super(instance, 280);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("labyrinth_zone_stone_stairs");
		}
