...
public class WorkshopRoofBlockBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:workshop_roof_block")
	public static final Block block = null;
	public WorkshopRoofBlockBlock(SonicraftModElements instance) {
		super(instance, 229);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("workshop_roof_block");
		}
