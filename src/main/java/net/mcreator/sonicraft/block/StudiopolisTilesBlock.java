...
public class StudiopolisTilesBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_tiles")
	public static final Block block = null;
	public StudiopolisTilesBlock(SonicraftModElements instance) {
		super(instance, 341);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_tiles");
		}
