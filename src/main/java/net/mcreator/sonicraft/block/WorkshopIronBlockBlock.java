...
public class WorkshopIronBlockBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:workshop_iron_block")
	public static final Block block = null;
	public WorkshopIronBlockBlock(SonicraftModElements instance) {
		super(instance, 232);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("workshop_iron_block");
		}
