...
public class GreenHillPalmFenceBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_hill_palm_fence")
	public static final Block block = null;
	public GreenHillPalmFenceBlock(SonicraftModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("green_hill_palm_fence");
		}
