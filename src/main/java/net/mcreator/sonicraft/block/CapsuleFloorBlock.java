...
public class CapsuleFloorBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:capsule_floor")
	public static final Block block = null;
	public CapsuleFloorBlock(SonicraftModElements instance) {
		super(instance, 23);
	}
