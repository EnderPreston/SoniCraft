...
public class ChiseledChaostoneBricksBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chiseled_chaostone_bricks")
	public static final Block block = null;
	public ChiseledChaostoneBricksBlock(SonicraftModElements instance) {
		super(instance, 192);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_chaostone_bricks");
		}
