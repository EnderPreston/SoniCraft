...
public class SilverSonicChamberBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:silver_sonic_chamber")
	public static final Block block = null;
	public SilverSonicChamberBlock(SonicraftModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.ANVIL).hardnessAndResistance(3.5f, 15f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("silver_sonic_chamber");
		}
