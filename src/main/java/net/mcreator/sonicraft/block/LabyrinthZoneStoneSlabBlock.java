...
public class LabyrinthZoneStoneSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:labyrinth_zone_stone_slab")
	public static final Block block = null;
	public LabyrinthZoneStoneSlabBlock(SonicraftModElements instance) {
		super(instance, 281);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("labyrinth_zone_stone_slab");
		}
