...
public class AquaticRuinBrickSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:aquatic_ruin_brick_slab")
	public static final Block block = null;
	public AquaticRuinBrickSlabBlock(SonicraftModElements instance) {
		super(instance, 275);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("aquatic_ruin_brick_slab");
		}
