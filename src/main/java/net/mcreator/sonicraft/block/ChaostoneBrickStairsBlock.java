...
public class ChaostoneBrickStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chaostone_brick_stairs")
	public static final Block block = null;
	public ChaostoneBrickStairsBlock(SonicraftModElements instance) {
		super(instance, 190);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("chaostone_brick_stairs");
		}
