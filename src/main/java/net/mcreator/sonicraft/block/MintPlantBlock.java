...
public class MintPlantBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:mint_plant")
	public static final Block block = null;
	public MintPlantBlock(SonicraftModElements instance) {
		super(instance, 15);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("mint_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:mint_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
