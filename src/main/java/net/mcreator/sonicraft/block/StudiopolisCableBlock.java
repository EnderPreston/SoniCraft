...
public class StudiopolisCableBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_cable")
	public static final Block block = null;
	public StudiopolisCableBlock(SonicraftModElements instance) {
		super(instance, 357);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHERITE).hardnessAndResistance(1f, 6f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("studiopolis_cable");
		}
