...
public class AquaticRuinBrickStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:aquatic_ruin_brick_stairs")
	public static final Block block = null;
	public AquaticRuinBrickStairsBlock(SonicraftModElements instance) {
		super(instance, 274);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("aquatic_ruin_brick_stairs");
		}
