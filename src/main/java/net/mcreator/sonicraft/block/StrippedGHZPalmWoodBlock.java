...
public class StrippedGHZPalmWoodBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:stripped_ghz_palm_wood")
	public static final Block block = null;
	public StrippedGHZPalmWoodBlock(SonicraftModElements instance) {
		super(instance, 176);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stripped_ghz_palm_wood");
		}
