...
public class AquaticRuinPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:aquatic_ruin_platform")
	public static final Block block = null;
	public AquaticRuinPlatformBlock(SonicraftModElements instance) {
		super(instance, 277);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aquatic_ruin_platform");
		}
