...
public class GreenHillPalmPlanksBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_hill_palm_planks")
	public static final Block block = null;
	public GreenHillPalmPlanksBlock(SonicraftModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_hill_palm_planks");
		}
