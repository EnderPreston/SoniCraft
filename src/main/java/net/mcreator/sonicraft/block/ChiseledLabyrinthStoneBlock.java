...
public class ChiseledLabyrinthStoneBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chiseled_labyrinth_stone")
	public static final Block block = null;
	public ChiseledLabyrinthStoneBlock(SonicraftModElements instance) {
		super(instance, 282);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_labyrinth_stone");
		}
