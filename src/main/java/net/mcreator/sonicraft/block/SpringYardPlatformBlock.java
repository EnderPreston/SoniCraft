...
public class SpringYardPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:spring_yard_platform")
	public static final Block block = null;
	public SpringYardPlatformBlock(SonicraftModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spring_yard_platform");
		}
