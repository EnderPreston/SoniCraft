...
public class ItemBoxBrokenBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:item_box_broken")
	public static final Block block = null;
	public ItemBoxBrokenBlock(SonicraftModElements instance) {
		super(instance, 385);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("item_box_broken");
		}
