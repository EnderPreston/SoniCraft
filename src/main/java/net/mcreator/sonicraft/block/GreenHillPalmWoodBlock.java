...
public class GreenHillPalmWoodBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_hill_palm_wood")
	public static final Block block = null;
	public GreenHillPalmWoodBlock(SonicraftModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_hill_palm_wood");
		}
