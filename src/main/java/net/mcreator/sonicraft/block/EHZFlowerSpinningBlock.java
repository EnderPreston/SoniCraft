...
public class EHZFlowerSpinningBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_flower_spinning")
	public static final Block block = null;
	public EHZFlowerSpinningBlock(SonicraftModElements instance) {
		super(instance, 1020);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ehz_flower_spinning"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ehz_flower_spinning"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ehz_flower_spinning");
		}
