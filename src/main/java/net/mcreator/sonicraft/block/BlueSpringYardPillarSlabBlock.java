...
public class BlueSpringYardPillarSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:blue_spring_yard_pillar_slab")
	public static final Block block = null;
	public BlueSpringYardPillarSlabBlock(SonicraftModElements instance) {
		super(instance, 257);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_spring_yard_pillar_slab");
		}
