...
public class BlueMarbleZonePillarBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:blue_marble_zone_pillar")
	public static final Block block = null;
	public BlueMarbleZonePillarBlock(SonicraftModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_marble_zone_pillar");
		}
