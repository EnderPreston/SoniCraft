...
public class MarbleZoneIronBlockBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:marble_zone_iron_block")
	public static final Block block = null;
	public MarbleZoneIronBlockBlock(SonicraftModElements instance) {
		super(instance, 210);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_zone_iron_block");
		}
