...
public class EHZFlowerBouncingBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_flower_bouncing")
	public static final Block block = null;
	public EHZFlowerBouncingBlock(SonicraftModElements instance) {
		super(instance, 1022);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ehz_flower_bouncing"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ehz_flower_bouncing"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ehz_flower_bouncing");
		}
