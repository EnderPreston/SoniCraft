...
public class WorkshopFloorSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:workshop_floor_slab")
	public static final Block block = null;
	public WorkshopFloorSlabBlock(SonicraftModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("workshop_floor_slab");
		}
