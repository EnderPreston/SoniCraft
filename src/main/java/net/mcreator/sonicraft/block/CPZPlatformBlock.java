...
public class CPZPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_platform")
	public static final Block block = null;
	public CPZPlatformBlock(SonicraftModElements instance) {
		super(instance, 224);
	}
