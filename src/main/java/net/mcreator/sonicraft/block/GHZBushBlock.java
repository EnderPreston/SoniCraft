...
public class GHZBushBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_bush")
	public static final Block block = null;
	public GHZBushBlock(SonicraftModElements instance) {
		super(instance, 12);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ghz_bush"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ghz_bush"), configuredFeature);
		}
	}
	@SubscribeEvent
