...
public class ChiseledMarbleZoneBricksBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chiseled_marble_zone_bricks")
	public static final Block block = null;
	public ChiseledMarbleZoneBricksBlock(SonicraftModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_marble_zone_bricks");
		}
