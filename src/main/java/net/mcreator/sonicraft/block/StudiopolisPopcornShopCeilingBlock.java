...
public class StudiopolisPopcornShopCeilingBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_popcorn_shop_ceiling")
	public static final Block block = null;
	public StudiopolisPopcornShopCeilingBlock(SonicraftModElements instance) {
		super(instance, 350);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_popcorn_shop_ceiling");
		}
