...
public class MarbleZoneBricksBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:marble_zone_bricks")
	public static final Block block = null;
	public MarbleZoneBricksBlock(SonicraftModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marble_zone_bricks");
		}
