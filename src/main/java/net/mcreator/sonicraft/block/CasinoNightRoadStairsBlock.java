...
public class CasinoNightRoadStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:casino_night_road_stairs")
	public static final Block block = null;
	public CasinoNightRoadStairsBlock(SonicraftModElements instance) {
		super(instance, 297);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.CLOTH).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.CLOTH).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(0)
							.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("casino_night_road_stairs");
		}
