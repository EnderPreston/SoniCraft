...
public class ChaostoneBrickWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chaostone_brick_wall")
	public static final Block block = null;
	public ChaostoneBrickWallBlock(SonicraftModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("chaostone_brick_wall");
		}
