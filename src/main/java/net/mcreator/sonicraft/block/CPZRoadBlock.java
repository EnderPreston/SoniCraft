...
public class CPZRoadBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_road")
	public static final Block block = null;
	public CPZRoadBlock(SonicraftModElements instance) {
		super(instance, 211);
	}
