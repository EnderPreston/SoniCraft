...
public class MarbleZoneStoneSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:marble_zone_stone_slab")
	public static final Block block = null;
	public MarbleZoneStoneSlabBlock(SonicraftModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_zone_stone_slab");
		}
