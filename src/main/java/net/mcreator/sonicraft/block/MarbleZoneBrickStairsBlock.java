...
public class MarbleZoneBrickStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:marble_zone_brick_stairs")
	public static final Block block = null;
	public MarbleZoneBrickStairsBlock(SonicraftModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_zone_brick_stairs");
		}
