...
public class StudiopolisClapperboardPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_clapperboard_platform")
	public static final Block block = null;
	public StudiopolisClapperboardPlatformBlock(SonicraftModElements instance) {
		super(instance, 344);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_clapperboard_platform");
		}
