...
public class GHZRockBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_rock")
	public static final Block block = null;
	public GHZRockBlock(SonicraftModElements instance) {
		super(instance, 183);
	}
