...
public class CPZPipeBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_pipe")
	public static final Block block = null;
	public CPZPipeBlock(SonicraftModElements instance) {
		super(instance, 216);
	}
