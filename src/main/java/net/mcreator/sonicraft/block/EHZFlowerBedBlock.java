...
public class EHZFlowerBedBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ehz_flower_bed")
	public static final Block block = null;
	public EHZFlowerBedBlock(SonicraftModElements instance) {
		super(instance, 1024);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ehz_flower_bed"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("sonicraft:ehz_flower_bed"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ehz_flower_bed");
		}

		@Override
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			Vector3d offset = state.getOffset(world, pos);
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 0.2, 16)).withOffset(offset.x, offset.y, offset.z);
		}
