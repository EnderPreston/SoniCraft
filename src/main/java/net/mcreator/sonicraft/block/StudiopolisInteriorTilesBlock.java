...
public class StudiopolisInteriorTilesBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_interior_tiles")
	public static final Block block = null;
	public StudiopolisInteriorTilesBlock(SonicraftModElements instance) {
		super(instance, 361);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_interior_tiles");
		}
