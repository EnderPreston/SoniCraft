...
public class GHZDirtStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_dirt_stairs")
	public static final Block block = null;
	public GHZDirtStairsBlock(SonicraftModElements instance) {
		super(instance, 171);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("ghz_dirt_stairs");
		}
