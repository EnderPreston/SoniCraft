...
public class StudiopolisInteriorPlatformBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_interior_platform")
	public static final Block block = null;
	public StudiopolisInteriorPlatformBlock(SonicraftModElements instance) {
		super(instance, 363);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_interior_platform");
		}
