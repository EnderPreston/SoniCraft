...
public class CasinoNightRoadSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:casino_night_road_slab")
	public static final Block block = null;
	public CasinoNightRoadSlabBlock(SonicraftModElements instance) {
		super(instance, 298);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("casino_night_road_slab");
		}
