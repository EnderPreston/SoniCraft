...
public class CPZBlueLampBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_blue_lamp")
	public static final Block block = null;
	public CPZBlueLampBlock(SonicraftModElements instance) {
		super(instance, 220);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.LANTERN).hardnessAndResistance(1f, 10f).setLightLevel(s -> 15)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("cpz_blue_lamp");
		}
