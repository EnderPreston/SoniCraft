...
import net.mcreator.sonicraft.procedures.StudiopolisTVUpdateTickProcedure;
...
public class StudiopolisTVBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_tv")
	public static final Block block = null;
	public StudiopolisTVBlock(SonicraftModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("studiopolis_tv");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				StudiopolisTVUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
