...
public class CasinoNightStoneSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:casino_night_stone_slab")
	public static final Block block = null;
	public CasinoNightStoneSlabBlock(SonicraftModElements instance) {
		super(instance, 301);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("casino_night_stone_slab");
		}
