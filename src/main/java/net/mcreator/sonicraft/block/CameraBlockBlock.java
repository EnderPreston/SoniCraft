...
public class CameraBlockBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:camera_block")
	public static final Block block = null;
	public CameraBlockBlock(SonicraftModElements instance) {
		super(instance, 972);
	}
