...
public class MarbleZoneBrickSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:marble_zone_brick_slab")
	public static final Block block = null;
	public MarbleZoneBrickSlabBlock(SonicraftModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marble_zone_brick_slab");
		}
