...
import net.mcreator.sonicraft.procedures.LabyrinthZoneStoneBlockAddedProcedure;
...
public class ScrapBrainStoneBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:scrap_brain_stone")
	public static final Block block = null;
	public ScrapBrainStoneBlock(SonicraftModElements instance) {
		super(instance, 288);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("scrap_brain_stone");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				LabyrinthZoneStoneBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
