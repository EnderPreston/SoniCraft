...
public class SmoothDeathEggOuterShellWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:smooth_death_egg_outer_shell_wall")
	public static final Block block = null;
	public SmoothDeathEggOuterShellWallBlock(SonicraftModElements instance) {
		super(instance, 322);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.NETHERITE).hardnessAndResistance(2f, 8f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("smooth_death_egg_outer_shell_wall");
		}
