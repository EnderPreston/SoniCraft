...
public class CasinoNightSlotFrameBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:casino_night_slot_frame")
	public static final Block block = null;
	public CasinoNightSlotFrameBlock(SonicraftModElements instance) {
		super(instance, 311);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.LANTERN).hardnessAndResistance(0.2f, 6f).setLightLevel(s -> 4)
			...
			setRegistryName("casino_night_slot_frame");
		}
