...
public class CPZPipeCornerBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_pipe_corner")
	public static final Block block = null;
	public CPZPipeCornerBlock(SonicraftModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("cpz_pipe_corner");
		}
