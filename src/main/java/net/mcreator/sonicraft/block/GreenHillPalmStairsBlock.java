...
public class GreenHillPalmStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_hill_palm_stairs")
	public static final Block block = null;
	public GreenHillPalmStairsBlock(SonicraftModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("green_hill_palm_stairs");
		}
