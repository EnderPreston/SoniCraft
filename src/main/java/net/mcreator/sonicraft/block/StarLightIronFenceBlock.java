...
public class StarLightIronFenceBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_iron_fence")
	public static final Block block = null;
	public StarLightIronFenceBlock(SonicraftModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.LANTERN).hardnessAndResistance(1.2f, 10f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("star_light_iron_fence");
		}
