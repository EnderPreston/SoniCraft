...
public class GHZDirtBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_dirt")
	public static final Block block = null;
	public GHZDirtBlock(SonicraftModElements instance) {
		super(instance, 171);
	}
