...
public class StudiopolisRoadSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:studiopolis_road_slab")
	public static final Block block = null;
	public StudiopolisRoadSlabBlock(SonicraftModElements instance) {
		super(instance, 338);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("studiopolis_road_slab");
		}
