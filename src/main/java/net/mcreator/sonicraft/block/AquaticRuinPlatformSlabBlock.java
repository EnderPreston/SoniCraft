...
public class AquaticRuinPlatformSlabBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:aquatic_ruin_platform_slab")
	public static final Block block = null;
	public AquaticRuinPlatformSlabBlock(SonicraftModElements instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("aquatic_ruin_platform_slab");
		}
