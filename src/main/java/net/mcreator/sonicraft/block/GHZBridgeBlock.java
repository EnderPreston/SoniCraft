...
public class GHZBridgeBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:ghz_bridge")
	public static final Block block = null;
	public GHZBridgeBlock(SonicraftModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 8, 0, 16, 16, 16)).withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 8, 0, 0, 16, 16)).withOffset(offset.x, offset.y, offset.z);
				case WEST :
