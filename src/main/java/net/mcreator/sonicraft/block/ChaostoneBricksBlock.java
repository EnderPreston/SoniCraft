...
public class ChaostoneBricksBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chaostone_bricks")
	public static final Block block = null;
	public ChaostoneBricksBlock(SonicraftModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chaostone_bricks");
		}
