...
public class CPZPillarBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cpz_pillar")
	public static final Block block = null;
	public CPZPillarBlock(SonicraftModElements instance) {
		super(instance, 218);
	}
