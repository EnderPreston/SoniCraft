...
public class CasinoNightStoneStairsBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:casino_night_stone_stairs")
	public static final Block block = null;
	public CasinoNightStoneStairsBlock(SonicraftModElements instance) {
		super(instance, 300);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("casino_night_stone_stairs");
		}
