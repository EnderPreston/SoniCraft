...
public class StarLightMetalWallBlock extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:star_light_metal_wall")
	public static final Block block = null;
	public StarLightMetalWallBlock(SonicraftModElements instance) {
		super(instance, 41);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1.35f, 15f).setLightLevel(s -> 0));
			setRegistryName("star_light_metal_wall");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A79This also works as a wall!"));
		}
