...
public class PurpleChaoFruitItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:purple_chao_fruit")
	public static final Item block = null;
	public PurpleChaoFruitItem(SonicraftModElements instance) {
		super(instance, 86);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("purple_chao_fruit");
		}
