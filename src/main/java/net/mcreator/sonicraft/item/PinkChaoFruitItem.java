...
public class PinkChaoFruitItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:pink_chao_fruit")
	public static final Item block = null;
	public PinkChaoFruitItem(SonicraftModElements instance) {
		super(instance, 87);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("pink_chao_fruit");
		}
