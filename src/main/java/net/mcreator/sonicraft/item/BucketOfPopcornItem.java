...
public class BucketOfPopcornItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:bucket_of_popcorn")
	public static final Item block = null;
	public BucketOfPopcornItem(SonicraftModElements instance) {
		super(instance, 88);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("bucket_of_popcorn");
		}
