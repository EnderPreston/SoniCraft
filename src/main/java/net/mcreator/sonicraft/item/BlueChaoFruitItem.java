...
public class BlueChaoFruitItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:blue_chao_fruit")
	public static final Item block = null;
	public BlueChaoFruitItem(SonicraftModElements instance) {
		super(instance, 85);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("blue_chao_fruit");
		}
