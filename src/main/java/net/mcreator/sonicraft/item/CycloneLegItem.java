...
public class CycloneLegItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:cyclone_leg")
	public static final Item block = null;
	public CycloneLegItem(SonicraftModElements instance) {
		super(instance, 129);
	}
