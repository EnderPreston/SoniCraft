...
public class MintCandyItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:mint_candy")
	public static final Item block = null;
	public MintCandyItem(SonicraftModElements instance) {
		super(instance, 78);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A79Tails loves these!"));
		}
	}
}
