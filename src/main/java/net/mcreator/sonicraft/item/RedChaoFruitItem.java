...
public class RedChaoFruitItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:red_chao_fruit")
	public static final Item block = null;
	public RedChaoFruitItem(SonicraftModElements instance) {
		super(instance, 81);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("red_chao_fruit");
		}
