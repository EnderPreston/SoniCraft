...
public class GreenChaoFruitItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:green_chao_fruit")
	public static final Item block = null;
	public GreenChaoFruitItem(SonicraftModElements instance) {
		super(instance, 84);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("green_chao_fruit");
		}
