...
public class ChiliDogItem extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:chili_dog")
	public static final Item block = null;
	public ChiliDogItem(SonicraftModElements instance) {
		super(instance, 77);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A79Sonic loves these!"));
		}
	}
}
