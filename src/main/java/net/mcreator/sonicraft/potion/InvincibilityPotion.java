...
public class InvincibilityPotion extends SonicraftModElements.ModElement {
	@ObjectHolder("sonicraft:invincibility")
	public static final Effect potion = null;
	public InvincibilityPotion(SonicraftModElements instance) {
		super(instance, 384);
	...
	public static class EffectCustom extends Effect {
		...
		public EffectCustom() {
			...
			potionIcon = new ResourceLocation("sonicraft:textures/invincibility.png");
		}
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			double z = entity.getPosZ();
			{
				...
				InvincibilityPotionStartedappliedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void performEffect(LivingEntity entity, int amplifier) {
			...
			double z = entity.getPosZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				InvincibilityOnPotionActiveTickProcedure.executeProcedure($_dependencies);
			}
		}
