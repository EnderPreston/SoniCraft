...
import net.mcreator.sonicraft.procedures.CaterkillerBodyEntityDiesProcedure;
import net.mcreator.sonicraft.entity.renderer.CaterkillerBodyRenderer;
...
public class CaterkillerBodyEntity extends SonicraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("caterkiller_body").setRegistryName("caterkiller_body");
	public CaterkillerBodyEntity(SonicraftModElements instance) {
		super(instance, 487);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CaterkillerBodyRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				CaterkillerBodyEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
