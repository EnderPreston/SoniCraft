...
@OnlyIn(Dist.CLIENT)
public class EggmanEntityMagnetRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EggmanEntityMagnetEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltikal(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/equals_p.png");
					}
				};
			});
		}
