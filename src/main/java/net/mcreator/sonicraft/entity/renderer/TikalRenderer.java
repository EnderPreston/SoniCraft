...
@OnlyIn(Dist.CLIENT)
public class TikalRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TikalEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltikal(), 0.5f) {
					{
						this.addLayer(new GlowingLayer<>(this));
					}
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/tikal.png");
					}
				};
			});
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("sonicraft:textures/tikal_glow.png")));
	...
	public static class Modeltikal extends EntityModel<Entity> {
		...
		public Modeltikal() {
			...
			sonic.addChild(hipR);
			hipR.setTextureOffset(22, 16).addBox(-1.0F, -1.25F, -1.0F, 2.0F, 8.0F, 2.0F, -0.25F, false);
			hipR.setTextureOffset(14, 26).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
			...
			sonic.addChild(hipL);
			hipL.setTextureOffset(22, 16).addBox(-1.0F, -1.25F, -1.0F, 2.0F, 8.0F, 2.0F, -0.25F, true);
			hipL.setTextureOffset(14, 26).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, true);
