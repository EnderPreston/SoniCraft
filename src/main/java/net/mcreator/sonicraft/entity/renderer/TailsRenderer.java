...
@OnlyIn(Dist.CLIENT)
public class TailsRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TailsEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltails(), 0.5f) {
					@Override
