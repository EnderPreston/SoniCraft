...
@OnlyIn(Dist.CLIENT)
public class PickyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PickyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpicky(), 0.2f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/picky.png");
					}
				};
			});
		}
	...
	public static class Modelpicky extends EntityModel<Entity> {
		...
		public Modelpicky() {
			...
			head.setTextureOffset(0, 0).addBox(-2.25F, -5.4375F, -1.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(0, 0).addBox(1.25F, -5.4375F, -1.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			nose = new ModelRenderer(this);
			nose.setRotationPoint(-1.0F, 2.0625F, -6.0F);
			head.addChild(nose);
			setRotationAngle(nose, 0.0F, 3.1416F, 0.0F);
			nose.setTextureOffset(0, 19).addBox(-3.0F, -4.75F, -4.0F, 4.0F, 3.0F, 1.0F, -0.75F, false);
		}
