...
@OnlyIn(Dist.CLIENT)
public class BlackMarketChaoRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BlackMarketChaoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelchao(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/chao_black_market.png");
					}
				};
			});
		}
