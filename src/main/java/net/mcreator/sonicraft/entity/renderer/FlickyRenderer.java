...
@OnlyIn(Dist.CLIENT)
public class FlickyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FlickyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelflicky(), 0.2f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/flicky.png");
					}
				};
			});
		}
