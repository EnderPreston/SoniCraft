...
@OnlyIn(Dist.CLIENT)
public class PockyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PockyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpocky(), 0.2f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/pocky.png");
					}
				};
			});
		}
