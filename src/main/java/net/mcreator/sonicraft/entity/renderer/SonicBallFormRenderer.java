...
@OnlyIn(Dist.CLIENT)
public class SonicBallFormRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SonicBallFormEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsonic_ball(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/sonic_ball.png");
					}
				};
			});
		}
