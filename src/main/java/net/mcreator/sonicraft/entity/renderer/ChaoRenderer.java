...
@OnlyIn(Dist.CLIENT)
public class ChaoRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ChaoEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelchao(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/chao.png");
					}
				};
			});
		}
