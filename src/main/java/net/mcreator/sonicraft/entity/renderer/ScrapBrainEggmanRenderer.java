...
@OnlyIn(Dist.CLIENT)
public class ScrapBrainEggmanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ScrapBrainEggmanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeleggman(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/eggman.png");
					}
				};
			});
		}
	...
	public static class Modeleggman extends EntityModel<Entity> {
