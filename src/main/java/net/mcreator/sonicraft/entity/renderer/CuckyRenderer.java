...
@OnlyIn(Dist.CLIENT)
public class CuckyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CuckyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcucky(), 0.2f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/cucky.png");
					}
				};
			});
		}
	...
	public static class Modelcucky extends EntityModel<Entity> {
		...
		public Modelcucky() {
			...
			head.setRotationPoint(-1.0F, -2.0F, 0.9167F);
			main.addChild(head);
			head.setTextureOffset(0, 0).addBox(-2.5F, -5.75F, -2.4167F, 5.0F, 6.0F, 5.0F, -0.25F, false);
			head.setTextureOffset(15, 2).addBox(-1.0F, -1.5F, -2.9167F, 2.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(21, 0).addBox(-0.5F, -7.0F, -1.4167F, 1.0F, 2.0F, 3.0F, 0.0F, false);
		}
