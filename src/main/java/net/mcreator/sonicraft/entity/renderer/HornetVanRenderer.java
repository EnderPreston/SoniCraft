...
@OnlyIn(Dist.CLIENT)
public class HornetVanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HornetVanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelhornet_van(), 1f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/hornet_van.png");
					}
				};
			});
		}
