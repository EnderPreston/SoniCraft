...
@OnlyIn(Dist.CLIENT)
public class CheeseEntityMagnetRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CheeseEntityMagnetEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltikal(), 0f) {
					@Override
