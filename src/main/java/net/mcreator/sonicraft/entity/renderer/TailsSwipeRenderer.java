...
@OnlyIn(Dist.CLIENT)
public class TailsSwipeRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(TailsSwipeEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeltails_swipe(), 0f) {
					@Override
