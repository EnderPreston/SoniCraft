...
@OnlyIn(Dist.CLIENT)
public class ReplicaShadowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ReplicaShadowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelshadow(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("sonicraft:textures/shadow_infinite.png");
					}
				};
			});
		}
