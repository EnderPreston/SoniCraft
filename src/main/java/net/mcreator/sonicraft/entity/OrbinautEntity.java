...
import net.mcreator.sonicraft.entity.renderer.OrbinautRenderer;
...
public class OrbinautEntity extends SonicraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 0.9f)).build("orbinaut").setRegistryName("orbinaut");
	public OrbinautEntity(SonicraftModElements instance) {
		super(instance, 1030);
		FMLJavaModLoadingContext.get().getModEventBus().register(new OrbinautRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737997, -154, new Item.Properties().group(SonicraftMiscItemGroup.tab))
				.setRegistryName("orbinaut_spawn_egg"));
	}
