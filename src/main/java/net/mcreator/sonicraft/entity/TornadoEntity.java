...
import net.mcreator.sonicraft.procedures.TornadoOnEntityTickUpdateProcedure;
import net.mcreator.sonicraft.item.TornadoItemItem;
import net.mcreator.sonicraft.entity.renderer.TornadoRenderer;
...
public class TornadoEntity extends SonicraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.8f, 1.2f)).build("tornado").setRegistryName("tornado");
	public TornadoEntity(SonicraftModElements instance) {
		super(instance, 627);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TornadoRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TornadoItemItem.block, (int) (1)));
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				TornadoOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
