...
public class CaterkillerEntity extends SonicraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6283104, -142, new Item.Properties().group(SonicraftMiscItemGroup.tab))
				.setRegistryName("caterkiller_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 11, 1, 1));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				CaterkillerEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CaterkillerPlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
