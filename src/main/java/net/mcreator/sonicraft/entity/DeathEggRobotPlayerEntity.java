...
import net.mcreator.sonicraft.procedures.DeathEggRobotPlayerOnEntityTickUpdateProcedure;
import net.mcreator.sonicraft.procedures.DeathEggRobotPlayerEntityDiesProcedure;
import net.mcreator.sonicraft.entity.renderer.DeathEggRobotPlayerRenderer;
...
public class DeathEggRobotPlayerEntity extends SonicraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.7999999999999998f, 9f)).build("death_egg_robot_player").setRegistryName("death_egg_robot_player");
	public DeathEggRobotPlayerEntity(SonicraftModElements instance) {
		super(instance, 858);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DeathEggRobotPlayerRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				DeathEggRobotPlayerEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				DeathEggRobotPlayerOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
