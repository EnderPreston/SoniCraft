...
import net.mcreator.sonicraft.entity.renderer.CaterkillerHeadRenderer;
...
public class CaterkillerHeadEntity extends SonicraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("caterkiller_head").setRegistryName("caterkiller_head");
	public CaterkillerHeadEntity(SonicraftModElements instance) {
		super(instance, 486);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CaterkillerHeadRenderer.ModelRegisterHandler());
