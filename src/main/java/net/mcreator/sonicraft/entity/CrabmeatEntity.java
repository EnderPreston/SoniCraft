...
public class CrabmeatEntity extends SonicraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -6710887, new Item.Properties().group(SonicraftMiscItemGroup.tab))
				.setRegistryName("crabmeat_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 9, 1, 2));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				MotobugEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
