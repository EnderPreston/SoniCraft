...
import net.mcreator.sonicraft.procedures.CycloneEntityIsHurtProcedure;
import net.mcreator.sonicraft.item.CycloneTurretItem;
import net.mcreator.sonicraft.item.CycloneItemItem;
import net.mcreator.sonicraft.entity.renderer.CycloneRenderer;
...
public class CycloneEntity extends SonicraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.8f, 2.4f)).build("cyclone").setRegistryName("cyclone");
	public CycloneEntity(SonicraftModElements instance) {
		super(instance, 593);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CycloneRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				CycloneEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
