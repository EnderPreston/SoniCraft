...
public class CycloneShootKeyBinding extends SonicraftModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	private long lastpress = 0;
	public CycloneShootKeyBinding(SonicraftModElements instance) {
		super(instance, 596);
	...
	public void initElements() {
		keys = new KeyBinding("key.sonicraft.cyclone_shoot", GLFW.GLFW_KEY_R, "key.categories.gameplay");
		...
		if (type == 0) {
			{
				...
				CycloneShootOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
		if (type == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				CycloneShootOnKeyReleasedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
