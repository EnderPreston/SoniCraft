...
public class PowerGeneratorEmeraldOnBlockRightClickedProcedure extends SonicraftModElements.ModElement {
	public PowerGeneratorEmeraldOnBlockRightClickedProcedure(SonicraftModElements instance) {
		super(instance, 792);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SonicraftMod.LOGGER.warn("Failed to load dependency entity for procedure PowerGeneratorEmeraldOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SonicraftMod.LOGGER.warn("Failed to load dependency x for procedure PowerGeneratorEmeraldOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SonicraftMod.LOGGER.warn("Failed to load dependency y for procedure PowerGeneratorEmeraldOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SonicraftMod.LOGGER.warn("Failed to load dependency z for procedure PowerGeneratorEmeraldOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SonicraftMod.LOGGER.warn("Failed to load dependency world for procedure PowerGeneratorEmeraldOnBlockRightClicked!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == PowerGeneratorGreenBlock.block.getDefaultState()
			...
			if (world instanceof World && !world.isRemote()) {
				((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
						(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.beacon.deactivate")),
