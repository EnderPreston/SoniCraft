...
public class InfiniteOnEntityTickUpdateProcedure extends SonicraftModElements.ModElement {
	public InfiniteOnEntityTickUpdateProcedure(SonicraftModElements instance) {
		super(instance, 688);
	}
