...
public class CycloneReticleParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public CycloneReticleParticle(SonicraftModElements instance) {
		super(instance, 579);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("cyclone_reticle"));
	}
