...
public class HintOrbParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public HintOrbParticle(SonicraftModElements instance) {
		super(instance, 646);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("hint_orb"));
	}
