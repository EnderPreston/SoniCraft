...
public class EnergyCubesParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public EnergyCubesParticle(SonicraftModElements instance) {
		super(instance, 673);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("energy_cubes"));
	}
