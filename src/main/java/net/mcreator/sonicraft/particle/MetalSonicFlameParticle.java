...
public class MetalSonicFlameParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public MetalSonicFlameParticle(SonicraftModElements instance) {
		super(instance, 574);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("metal_sonic_flame"));
	}
