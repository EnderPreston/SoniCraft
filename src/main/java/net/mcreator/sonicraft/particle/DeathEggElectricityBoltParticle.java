...
public class DeathEggElectricityBoltParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public DeathEggElectricityBoltParticle(SonicraftModElements instance) {
		super(instance, 817);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("death_egg_electricity_bolt"));
	}
