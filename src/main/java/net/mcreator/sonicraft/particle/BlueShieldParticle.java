...
public class BlueShieldParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public BlueShieldParticle(SonicraftModElements instance) {
		super(instance, 395);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("blue_shield"));
	}
