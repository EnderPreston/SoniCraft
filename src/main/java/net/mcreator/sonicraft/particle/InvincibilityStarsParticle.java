...
public class InvincibilityStarsParticle extends SonicraftModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public InvincibilityStarsParticle(SonicraftModElements instance) {
		super(instance, 381);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("invincibility_stars"));
	}
