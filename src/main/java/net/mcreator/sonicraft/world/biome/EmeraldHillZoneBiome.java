...
public class EmeraldHillZoneBiome extends SonicraftModElements.ModElement {
	public static Biome biome;
	public EmeraldHillZoneBiome(SonicraftModElements instance) {
		super(instance, 1028);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777072).setWaterColor(-14390020).setWaterFogColor(329011)
						.withSkyColor(-16777072).withFoliageColor(10387789).withGrassColor(9470285)
						.setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("sonicraft:music.game.emeraldhill")))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EHZGrassBlock.block.getDefaultState(),
								EHZDirtBlock.block.getDefaultState(), EHZDirtBlock.block.getDefaultState())));
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(MotobugEntity.entity, 1, 1, 1));
				...
				event.getRegistry().register(biome.setRegistryName("sonicraft:emerald_hill_zone"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("emerald_hill_zone_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("emerald_hill_zone_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("emerald_hill_zone_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
